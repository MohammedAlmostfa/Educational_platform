// web/sw.js
const CACHE_NAME = 'aqaviatec-v1.0.1';
const RUNTIME_CACHE = 'runtime-v1';

// الملفات التي نريد تخزينها بشكل دائم - أضف ملفات Flutter الأساسية
const PRECACHE_URLS = [
  './',
  './index.html',
  './manifest.json',
  ...
  './icons/Icon-192.png',
  './icons/Icon-512.png',
  // ملفات Flutter الأساسية (سيتم إضافتها تلقائياً عند التحميل)
